...
Set the name of this element to `ModUpdateNotifier` and the "Sem Version" to `^2.2.2` or [whatever the latest version is](https://ficsit.app/mod/ModUpdateNotifier)
